  ...
  <body>
    ...
    <form method="post" enctype="multipart/form-data" class="container-fluid mt-3">
      ...
      <div class="form-floating mb-2">
        <textarea class="form-control border-top-0 border-start-0 border-end-0 rounded-bottom-0 border-3 focus-ring focus-ring-dark" style="height: 250px;" type="text" onkeydown="if(event.keyCode == 13) { document.execCommand('insertHTML', false, '<br><br>'); return false; }" name="synopsis" placeholder="Enter synopsis" maxlength="450" required></textarea>
