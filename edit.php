...
<html>
  ...
  <body>
    ...
    <form method="post" class="container mt-3">
      ...
      <div class="form-floating mb-2">
        <textarea class="form-control text-secondary fw-bold" style="height: 400px;" name="content" onkeydown="if(event.keyCode == 13) { document.execCommand('insertHTML', false, '<br><br>'); return false; }" placeholder="Enter content"><?php echo strip_tags(str_replace('<br />', "\n", $post['content'])) ?></textarea>
